...
ggplot(nyData, aes(reorder(Industry, Employees, FUN = median), Employees)) + 
  ...
  coord_flip() +
  geom_hline(yintercept = median(nyData$Employees), color="steelblue", linetype="dotted") +
  geom_text(aes(x=2, label="Overall Median for NY", y = medianNY + 60), size = 2, colour="steelblue") +
