...
# Create a new column called RPE that stores the Revenue per Employee for each case
rpeData$RPE <- rpeData$Revenue / rpeData$Employees

# Sample of the dataframe
head(rpeData)

# Obtain the max, min, and medians based on the RPE variable
upperRPE <- max(rpeData$RPE)
lowerRPE <- min(rpeData$RPE)
medianRPE <- median(rpeData$RPE)
